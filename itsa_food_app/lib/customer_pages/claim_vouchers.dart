                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Color(0xFF6E473B), // #6E473B for user info
                      ),
                    ),
                    SizedBox(height: 4),
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 16,
                        color: Color(0xFFA78D78), // #A78D78 for email
                      ),
                    ),
                  ],
                ),
                    ...
                    return Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 18,
                          color:
                              Color(0xFFA78D78), // #A78D78 for no data message
                        ),
                      ),
                    );
                  }
                    ...
                    child: ExpansionTile(
                      title: Text(
                        ...
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: Color(0xFF6E473B), // #6E473B for section title
                        ),
                      ),
                      children: [
                        Column(
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                leading: Icon(
                                  Icons.local_offer,
                                  color: Color(
                                      0xFF6E473B), // #6E473B for icon color
                                  size: 40,
                                ),
                                title: Text(
                                  voucherCode,
                                  style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.bold,
                                    color: Color(
                                        0xFF6E473B), // #6E473B for voucher title
                                  ),
                                ),
                                subtitle: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                trailing: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: Color(
                                        0xFF6E473B), // #6E473B for button background
                                    shape: RoundedRectangleBorder(
                    ...
                    return Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 18,
                          color: Color(
                              0xFFA78D78), // #A78D78 for no claimed message
                        ),
                      ),
                    );
                  }
